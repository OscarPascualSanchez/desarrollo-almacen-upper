...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/measurement"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            ...
                                            <th width=120>Unidad de medida (short)</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_measurement[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_measurement('', 'unit_measurement', 'ASC', $batas, $page, '', $like_measurement) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <td>
                                                            <?php echo $row->unit_measurement_short; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->note; ?>
                                                        </td>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/measurement/edit/<?php echo $row->id_measurement; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_measurement; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->unit_measurement; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/measurement/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/measurement/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-measurement">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/measurement/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Unidad de medida</label>
                                            <input type="text" class="form-control input-sm" id="unit_measurement" name="unit_measurement" placeholder="Escribe la unidad de medida" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Unidad de medida (short)</label>
                                            <input type="text" class="form-control input-sm" id="unit_measurement_short" name="unit_measurement_short" placeholder="Escribe la unidad de medida abreviado" required />
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/measurement'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/measurement">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/measurement/edit/<?php echo $id_platform; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_measurement" value="<?php echo $id_measurement; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Unidad de medida</label>
                                            <input type="text" value="<?php echo $unit_measurement; ?>" class="form-control input-sm" id="unit_measurement" name="unit_measurement" placeholder="Escribe la unidad de medida" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Unidad de medida (short)</label>
                                            <input type="text" value="<?php echo $unit_measurement_short; ?>" class="form-control input-sm" id="unit_measurement_short" name="unit_measurement_short" placeholder="Escribe la unidad de medida abreviado" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nota</label>
