...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/operation"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>Id</th>
                                            <th width=120>Tipo de operación</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_operation[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_operation('', 'type_operation', 'ASC', $batas, $page, '', $like_operation) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/operation/edit/<?php echo $row->id_operation; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_operation; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->type_operation; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/operation/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/operation/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-operation">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/operation/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de operación</label>
                                            <input type="text" class="form-control input-sm" id="type_operation" name="type_operation" placeholder="Escribe el tipo de maniobra" required />
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/operation'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/operation">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/operation/edit/<?php echo $id_operation; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_operation" value="<?php echo $id_operation; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de operación</label>
                                            <input type="text" value="<?php echo $type_operation; ?>" class="form-control input-sm" id="type_operation" name="type_operation" placeholder="Escribe el tipo de operación" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nota</label>
