...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
        ...
        <div class="page-content container-fluid">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $i    = $page + 1;
                                                $like_boarding[$cari]            = $q;
                                                if ($jml_data > 0) {
                                                    foreach ($this->ADM->grid_all_boarding('', 'id_boarding', 'ASC', $batas, $page, '', $like_boarding) as $row) {
                                                ?>
                                                        <tr>
                                                            <td>
                                                                <?php echo $i; ?>
                                                            ...
                                                            <?php if ($admin->admin_level_kode == 1) { ?>
                                                                <td class="text-center action">
                                                                    <a class="btn-update" href="<?php echo site_url(); ?>website/boarding/edit/<?php echo $row->id_boarding; ?>">
                                                                        <i class="icon wb-pencil"></i>
                                                                    </a>
                                                                    <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_boarding; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->identification_number; ?>">
                                                ...
                                                <div class='pagination-right'>
                                                    <ul class="pagination">
                                                        <?php if ($jml_halaman > 1) {
                                                            echo pages($halaman, $jml_halaman, 'website/boarding/view', $id = "");
                                                        } ?>
                                                    </ul>
                                                </div>
                                            </div>
            ...
            <?php if ($admin->admin_level_kode == 1) { ?>
                <a href="<?php echo site_url(); ?>website/boarding/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-boarding">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/boarding/tambah/<?php echo $id_boarding; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h5>Datos generales del embarque</h5>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-4 mt-2">
                                                        <!-- Campo para el identificador -->
                                                        <input type="hidden" name="id_boarding" value="<?php echo $id_boarding; ?>">
                                                        ...
                                                        <div class="form-group form-material">
                                                            ...
                                                            <input type="text" class="form-control input-sm" id="event_type" name="event_type" value="Embarque" readonly />
                                                        </div>
                                                        <div class="form-group">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <table class="table table-striped table-bordered" id="productsTable">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products[0][stock]" placeholder="Introduce el stock" id="stock_0" oninput="actualizarQuantityPallet(0)" required />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[0][quantity_product_pallet]" placeholder="Escribe la cantidad de producto por pallets" id="quantity_product_pallet_0" oninput="actualizarQuantityPallet(0); updateQuantityProductByPallet(0);" required />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[0][quantity_pallet]" placeholder="Escribe la cantidad de pallets" id="quantity_pallet_0" oninput="actualizarPalletsOk(0)" readonly required />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[0][damaged_pallets]" placeholder="Escribe la cantidad de pallets dañados" id="damaged_pallets_0" oninput="actualizarPalletsOk(0); updateQuantityPallet(0);" required />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="number" step="any" class="form-control input-sm" name="products[0][damaged_stock]" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" placeholder="Escribe el stock dañado" id="damaged_stock_0" oninput="actualizarStockOk(0); updateDamagedStock(0);" required />
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group form-material">
                                                                ...
                                                                <!-- <td>
                                                                    <div class="form-group form-material">
                                                                        <input type="text" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products[0][available_pallets]" id="available_pallets_0" required />
                                                                    </div>
                                                                </td>-->
                                                ...
                                                <div class='button center'>
                                                    ...
                                                    <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/boarding'" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <a href="<?php echo site_url(); ?>website/boarding">
        <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
    ...
    <script>
        ...
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products[${rowIndex}][stock]" placeholder="Introduce el stock" id="stock_${rowIndex}" oninput="actualizarQuantityPallet(${rowIndex})" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[${rowIndex}][quantity_product_pallet]" placeholder="Escribe la cantidad de producto por pallets" id="quantity_product_pallet_${rowIndex}" oninput="actualizarQuantityPallet(${rowIndex})" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[${rowIndex}][quantity_pallet]" placeholder="Escribe la cantidad de pallets" id="quantity_pallet_${rowIndex}" readonly required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[${rowIndex}][damaged_pallets]" placeholder="Escribe la cantidad de pallets dañados" id="damaged_pallets_${rowIndex}" oninput="actualizarPalletsOk(${rowIndex})" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products[${rowIndex}][damaged_stock]" placeholder="Escribe el stock dañado" id="damaged_stock_${rowIndex}" oninput="actualizarStockOk(${rowIndex})" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 180px;" name="products[${rowIndex}][good_pallets]" placeholder="Escribe la cantidad de pallets OK" id="good_pallets_${rowIndex}" readonly required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products[${rowIndex}][good_stock]" placeholder="Escribe el stock OK" id="good_stock_${rowIndex}" readonly required />
            </div>
        </td>
    ...
    <script>
        ...
        function actualizarQuantityPallet(index) {
            const stockInicial = parseFloat(document.getElementById(`stock_${index}`).value) || 0;
            const quantityProductPallet = parseFloat(document.getElementById(`quantity_product_pallet_${index}`).value) || 0;

            const quantityPallet = stockInicial / quantityProductPallet;
            const quantityPalletFormatted = quantityPallet.toFixed(2);
            document.getElementById(`quantity_pallet_${index}`).value = quantityPalletFormatted;
...
<?php } elseif ($action == 'edit') { ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/boarding/edit/<?php echo $id_boarding; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                            ...
                                                            <?php if (isset($productss) && is_array($productss)) : ?>
                                                                <?php foreach ($productss as $product) : ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group form-material">
                                                                                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products_update[<?php echo $index; ?>][stock]" value="<?php echo $product->stock; ?>" placeholder="Introduce el stock" id="stock_<?php echo $index; ?>" oninput="actualizarQuantityPallet(<?php echo $index; ?>)" required />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group form-material">
                                                                                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products_update[<?php echo $index; ?>][quantity_product_pallet]" value="<?php echo $product->quantity_product_pallet; ?>" placeholder="Escribe la cantidad de producto por pallets" id="quantity_product_pallet_<?php echo $index; ?>" oninput="actualizarQuantityPallet(<?php echo $index; ?>); updateQuantityProductByPallet(<?php echo $index; ?>)" required />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group form-material">
                                                                                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products_update[<?php echo $index; ?>][quantity_pallet]" value="<?php echo $product->quantity_pallet; ?>" placeholder="Escribe la cantidad de pallets" id="quantity_pallet_<?php echo $index; ?>" oninput="actualizarPalletsOk(<?php echo $index; ?>)" readonly required />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group form-material">
                                                                                <input type="number" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" name="products_update[<?php echo $index; ?>][damaged_pallets]" value="<?php echo $product->damaged_pallets; ?>" placeholder="Escribe la cantidad de pallets dañados" id="damaged_pallets_<?php echo $index; ?>" oninput="actualizarPalletsOk(<?php echo $index; ?>); updateQuantityPallet(<?php echo $index; ?>)" required />
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                            <div class="form-group form-material">
                                                                       ...
                                                                       <!-- <td>
                                                                            <div class="form-group form-material">
                                                                                <input type="text" step="any" class="form-control input-sm" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" name="products_update[<?php echo $index; ?>][available_pallets]" value="<?php echo  $product->stock; ?>" id="available_pallets_<?php echo $index; ?>" readonly required />
                                                                            </div>
                                                                        </td>-->
                                                                        <td>
                                                                            <div class="form-group form-material">
    ...
    <script>
        ...
        <td>
            <div class="form-group form-material">
                <input type="number" class="form-control input-sm" name="products_insert[${index}][stock]" id="stock_${index}" oninput="actualizarQuantityPallet(${index})" style="padding: 5px; font-size: 12px; text-align: center; width: 150px;" placeholder="Introduce el stock" required />
            </div>    
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" class="form-control input-sm" name="products_insert[${index}][quantity_product_pallet]" id="quantity_product_pallet_${index}" oninput="actualizarQuantityPallet(${index}); updateQuantityProductByPallet(${index})" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" placeholder="Escribe la cantidad de producto por pallets" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" class="form-control input-sm" name="products_insert[${index}][quantity_pallet]" id="quantity_pallet_${index}" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" placeholder="Escribe la cantidad de pallets" readonly required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
                <input type="number" class="form-control input-sm" name="products_insert[${index}][damaged_pallets]" id="damaged_pallets_${index}" oninput="actualizarPalletsOk(${index}); updateQuantityPallet(${index})" style="padding: 5px; font-size: 12px; text-align: center; width: 200px;" placeholder="Escribe la cantidad de pallets dañados" required />
            </div>
        </td>
        <td>
            <div class="form-group form-material">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('input', '[id^=stock_], [id^=quantity_product_pallet_], [id^=damaged_pallets_], [id^=damaged_stock_]', function() {
                ...
                actualizarQuantityPallet(index);
            });
            ...
            $('#addRowButton').on('click', function() {
                ...
                actualizarQuantityPallet(newRowIndex);
            });
        });
