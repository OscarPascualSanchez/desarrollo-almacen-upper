...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/container"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>ID</th>
                                            <th width=120>Identificador(Número)</th>
                                            <th width=150>Tipo de contenedor</th>
                                            <th width=120>Sello de seguridad</th>
                                            <th width=270>Estatus</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_container[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_container('', 'container_type', 'ASC', $batas, $page, '', $like_container) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/container/edit/<?php echo $row->id_container; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_container; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->container_type; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/container/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/container/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-container">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/container/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Identificador(Número)</label>
                                            <input type="text" class="form-control input-sm" id="container_number" name="container_number" placeholder="Número de identificación del contenerdor" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de contenedor</label>
                                            <input type="text" class="form-control input-sm" id="container_type" name="container_type" placeholder="Escribe el tipo de contenedor" required>
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Sello de seguridad</label>
                                            <input type="text" class="form-control input-sm" id="security_seal" name="security_seal" placeholder="Escribe el sello de seguridad">
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/container'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/container">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/container/edit/<?php echo $id_container; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_container" value="<?php echo $id_container; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Número de contendor</label>
                                            <input type="text" value="<?php echo $container_number; ?>" class="form-control input-sm" id="container_number" name="container_number" placeholder="Escribe el número de identificación del contenedor" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de contendor</label>
                                            <input type="text" value="<?php echo $container_type; ?>" class="form-control input-sm" id="container_type" name="container_type" placeholder="Escribe el tipo de contenedor">
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Sello de seguridad</label>
                                            <input type="text" value="<?php echo $security_seal; ?>" class="form-control input-sm" id="security_seal" name="security_seal" placeholder="Escribe el sello de seguridad">
                                        </div>
                                        <div class="form-group form-material">
