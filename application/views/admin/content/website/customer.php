                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_customer('', 'id_customer', 'ASC', $batas, $page, '', $like_customer) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <td>
                                                            <?php echo $row->customer_created ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->customer_updated ?>
                                                        </td>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                ...
                                                                $url_fisica = site_url() . 'website/customer/edit_fisica/' . $row->id_customer;
                                                                $url_moral = site_url() . 'website/customer/edit/' . $row->id_customer;
                                                                ...
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_customer; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->nama_customer; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/customer/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            ...
                            <form action="<?php echo site_url(); ?>website/customer/tambah" method="post" id="formMoral" autocomplete="off" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <div class="form-group form-material">
                                            ...
                                            <input type="text" class="form-control input-sm" id="nama_customer" name="nama_customer" placeholder="Nombre de la empresa" required />
                                        </div>
                                        <div class="form-group form-material">
                            ...
                            <form action="<?php echo site_url(); ?>website/customer/tambah" method="post" id="formFisica" autocomplete="off" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-material">
                                            ...
                                            <input type="text" class="form-control input-sm" id="nama_customer" name="nama_customer" placeholder="Nombre" required />
                                        </div>
                                        <div class="form-group form-material">
    ...
    <div class="page">
        ...
        <script>
            function updateDateTime() {
                ...
                document.getElementById('customer_updated').value = formattedDateTime;
            }
                            ...
                            <form action="<?php echo site_url(); ?>website/customer/edit/<?php echo $id_customer; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nombre del cliente</label>
                                            <input type="text" value="<?php echo $nama_customer; ?>" class="form-control input-sm" id="nama_customer" name="nama_customer" placeholder="Escribe el nuevo nombre" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nombre comercial</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-material">
                                            ...
                                            <input type="text" value="<?php echo $notelp_customer; ?>" class="form-control input-sm" id="notel_customer" name="notelp_customer" placeholder="Escribe el nuevo número de teléfono">
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Fecha de creación del proveedor</label>
                                            <input type="text" value="<?php echo $customer_created; ?>" class="form-control input-sm" id="customer_created" name="customer_created" readonly>
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText"> Fecha de última modificación</label>
                                            <input type="text" value="<?php echo $cusstomer_updated; ?>" class="form-control input-sm" id="customer_updated" name="customer_updated" readonly>
                                        </div>
                                        <div class='button center'>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/customer/edit_fisica/<?php echo $id_customer; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_customer" value="<?php echo $id_customer; ?>" />
                                        <div class="form-group form-material">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText"> Fecha de última modificación</label>
                                            <input type="text" value="<?php echo $customer_updated; ?>" class="form-control input-sm" id="customer_updated" name="customer_updated" readonly>
                                        </div>
                                        <div class='button center'>
                                            <input class="btn btn-success btn-sm" type="submit" name="simpan" value="Actualizar datos" id="validateButton2">
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/customer'" />
