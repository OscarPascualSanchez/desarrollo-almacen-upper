...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/type_movement"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>Id</th>
                                            <th width=120>Tipo de movimiento</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_type_movement[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_type_movement('', 'id_type_movement', 'ASC', $batas, $page, '', $like_type_movement) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/type_movement/edit/<?php echo $row->id_type_movement; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_type_movement; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->type_movement; ?>">
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="8" class="style-center">¡No hay datos aún!</td> <!--No data yet!-->
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/type_movement/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/type_movement/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-type_movement">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/type_movement/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de movimiento</label>
                                            <input type="text" class="form-control input-sm" id="type_movements" name="type_movements" placeholder="Escribe el tipo de movimiento" required />
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/type_movement'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/type_movement">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/type_movement/edit/<?php echo $id_type_movement; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_type_movement" value="<?php echo $id_type_movement; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de movimiento</label>
                                            <input type="text" value="<?php echo $type_movements; ?>" class="form-control input-sm" id="type_movements" name="type_movements" placeholder="Escribe el tipo de movimiento" required />
                                        </div>
                                        <div class="form-group form-material">
