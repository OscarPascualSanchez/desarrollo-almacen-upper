...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/destination"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>Id</th>
                                            <th width=120>Nombre de destino</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_destination[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_destination('', 'destination_name', 'ASC', $batas, $page, '', $like_destination) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <td>
                                                            <?php echo dateIndo($row->destination_created); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->modified_by; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo dateIndo($row->destination_updated); ?>
                                                        </td>
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/destination/edit/<?php echo $row->id_destination; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_destination; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->destination_name; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/destination/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/destination/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-destination">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/destination/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-6 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nombre de destino</label>
                                            <input type="text" class="form-control input-sm" id="destination_name" name="destination_name" placeholder="Escribe el nombre de destino" required />
                                        </div>
                                        <div class="form-group form-material">
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/destination'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/destination">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
    ...
    <div class="page">
        ...
        <script>
            function updateDateTime() {
                ...
                document.getElementById('destination_updated').value = formattedDateTime;
            }
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/destination/edit/<?php echo $id_destination; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_destination" value="<?php echo $id_destination; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nombre de destino</label>
                                            <input type="text" value="<?php echo $destination_name; ?>" class="form-control input-sm" id="destination_name" name="destination_name" placeholder="Escribe el nombre de destino" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Calle</label>
                                    ...
                                    <div class="form-group form-material">
                                        ...
                                        <div class="form-group form-material">
                                            ...
                                            <input type="datetime" value="<?php echo $destination_created; ?>" class="form-control input-sm" id="destination_created" name="destination_created" readonly>
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class="form-group form-material">
                                            ...
                                            <input type="text" value="<?php echo $destination_updated; ?>" class="form-control input-sm" id="destination_updated" name="destination_updated" readonly >
                                        </div>
                                        <div class='button center'>
