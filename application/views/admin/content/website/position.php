...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/position"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>Id</th>
                                            <th width=120>Ubicación (fila)</th>
                                            <th width=150>Ubicación (columna)</th>
                                            <th width=150>Número de rack</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_position[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_position('', 'id_position', 'ASC', $batas, $page, '', $like_position) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <td>
                                                            <?php echo $row->row_location; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->column_location; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->rack_number; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $row->level; ?>
                                                        </td>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/position/edit/<?php echo $row->id_position; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_position; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->type_position; ?>">
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="12" class="style-center">¡No hay datos aún!</td> <!--No data yet!-->
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/position/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/position/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-position">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/position/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Ubicación (Fila)</label>
                                            <input type="number" class="form-control input-sm" id="row_location" name="row_location" placeholder="Escribe el número de fila" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Ubicación (Columna)</label>
                                            <input type="text" class="form-control input-sm" id="column_location" name="column_location" placeholder="Escribe la letra de la columna" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Número de rack</label>
                                            <input type="text" class="form-control input-sm" id="rack_number" name="rack_number" placeholder="Escribe el número de rack" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nivel del rack</label>
                                            <input type="text" class="form-control input-sm" id="level" name="level" placeholder="Escribe el nivel del rack" required />
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/position'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/position">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/position/edit/<?php echo $id_position; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_position" value="<?php echo $id_position; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Ubicación (fila)</label>
                                            <input type="text" value="<?php echo $row_location; ?>" class="form-control input-sm" id="row_location" name="row_location" placeholder="Escribe el número de fila" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Ubicación (columna)</label>
                                            <input type="text" value="<?php echo $column_location; ?>" class="form-control input-sm" id="column_location" name="column_location" placeholder="Escribe la ubicación">
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Número de rack</label>
                                            <input type="text" value="<?php echo $rack_number; ?>" class="form-control input-sm" id="rack_number" name="rack_number" placeholder="Escribe el número de rack">
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nivel</label>
                                            <input type="text" value="<?php echo $level; ?>" class="form-control input-sm" id="level" name="level" placeholder="Escribe el nivel del rack">
                                        </div>
                                        <div class="form-group form-material">
