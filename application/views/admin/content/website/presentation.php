...
<?php if ($action == 'view' || empty($action)) { ?>
    <div class="page">
                            ...
                            <div class="table-full table-view">
                                    ...
                                    <form action="" method="post" id="form">
                                        ...
                                        <div class='btn-navigation'>
                                            <div class='pull-right'>
                                                <a class="btn btn-success" href="<?php echo site_url(); ?>website/presentation"><i class="fa fa-refresh"></i></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead>
                                            <th width=80>Id</th>
                                            <th width=120>Tipo de presentación</th>
                                            <th width=150>Nota</th>
                                            <th width=120>Estatus</th>
                                            <th width="120">Altura permitida</th>
                                            <th width=270>Creado por</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i    = $page + 1;
                                            $like_presentation[$cari]            = $q;
                                            if ($jml_data > 0) {
                                                foreach ($this->ADM->grid_all_presentation('', 'type_presentation', 'ASC', $batas, $page, '', $like_presentation) as $row) {
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $i; ?>
                                                        ...
                                                        <?php if ($admin->admin_level_kode == 1) { ?>
                                                            <td class="text-center action">
                                                                <a class="btn-update" href="<?php echo site_url(); ?>website/presentation/edit/<?php echo $row->id_presentation; ?>">
                                                                    <i class="icon wb-pencil"></i>
                                                                </a>
                                                                <a class="text-danger" href="javascript:;" data-id="<?php echo $row->id_presentation; ?>" data-toggle="modal" data-target="#modal-konfirmasi" title="<?php echo $row->type_presentation; ?>">
                                            ...
                                            <div class='pagination-right'>
                                                <ul class="pagination">
                                                    <?php if ($jml_halaman > 1) {
                                                        echo pages($halaman, $jml_halaman, 'website/presentation/view', $id = "");
                                                    } ?>
                                                </ul>
                                            </div>
                                        </div>
        ...
        <?php if ($admin->admin_level_kode == 1) { ?>
            <a href="<?php echo site_url(); ?>website/presentation/tambah">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="javascript:;" class="btn btn-danger" id="hapus-presentation">Sí</a>
...
<?php } elseif ($action == 'tambah') { ?>
    <div class="page">
                ...
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/presentation/tambah" method="post" id="exampleStandardForm" autocomplete="off">
                                <!-- Campos del formulario Moral -->
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de presentación</label>
                                            <input type="text" class="form-control input-sm" id="type_presentation" name="type_presentation" placeholder="Escribe el tipo de presentación" required />
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputNumber">Altura</label>
                                            <input type="number" class="form-control input-sm" id="height" name="height" placeholder="Escribe la altura permitida">
                                        </div>
                                        <div class="form-group form-material">
                                        ...
                                        <div class='button center'>
                                            ...
                                            <input class="btn btn-danger btn-sm" type="reset" name="batal" value="Cancelar" onclick="location.href='<?php echo site_url(); ?>website/presentation'" />
                                        </div>
                                    </div>
                                </div>
                            </form>
        ...
        <a href="<?php echo site_url(); ?>website/presentation">
            <button class="site-action btn-raised btn btn-sm btn-floating blue" type="button">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel rounded-0">
                        ...
                        <div class="panel-body container-fluid">
                            <form action="<?php echo site_url(); ?>website/presentation/edit/<?php echo $id_presentation; ?>" method="post" id="exampleStandardForm" autocomplete="off">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_presentation" value="<?php echo $id_presentation; ?>" />
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Tipo de presentación</label>
                                            <input type="text" value="<?php echo $type_presentation; ?>" class="form-control input-sm" id="type_presentation" name="type_presentation" placeholder="Escribe el tipo de presentación" required />
                                        </div>
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputText">Nota</label>
                                        ...
                                        <div class="form-group form-material">
                                            <label class="control-label" for="inputNumber">Altura</label>
                                            <input type="number" value="<?php echo $height; ?>" class="form-control input-sm" id="height" name="height" placeholder="Escribe la altura permitida">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-material">
